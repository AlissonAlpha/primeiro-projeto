    ...
    if generate_image:
        try:
            ...
            img = generate_and_store_nano(
                ...
                texts={
                    "tagline": theme[:45],
                    "headline": hook[:80] if hook else theme[:60],
                    "subtext": copy_direction[:90] if copy_direction else "",
                    "cta": cta[:30] if cta else "Saiba Mais",
                },
                logo_url=logo,
                brand_color=dom_color or "#1a1a1a",
                accent_color=acc_color or "#fccc04",
                layout="bottom_bar",
                compose=True,
            )
